...
VTKRENDERINGCONTEXTOPENGL2_EXPORT void AddRegistrar_vtkRenderingContextOpenGL2();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingContextOpenGL2_SerDesRegistrar
  {
    vtkRenderingContextOpenGL2_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingContextOpenGL2();
    }
  } vtkRenderingContextOpenGL2_SerDesRegistrar_Instance;
}
