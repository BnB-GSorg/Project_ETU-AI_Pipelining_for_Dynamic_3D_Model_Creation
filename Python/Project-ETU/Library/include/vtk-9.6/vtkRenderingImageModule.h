...
VTKRENDERINGIMAGE_EXPORT void AddRegistrar_vtkRenderingImage();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingImage_SerDesRegistrar
  {
    vtkRenderingImage_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingImage();
    }
  } vtkRenderingImage_SerDesRegistrar_Instance;
}
