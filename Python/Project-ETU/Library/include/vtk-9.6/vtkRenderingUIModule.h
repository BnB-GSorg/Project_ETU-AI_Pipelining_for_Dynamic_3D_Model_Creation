...
VTKRENDERINGUI_EXPORT void AddRegistrar_vtkRenderingUI();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingUI_SerDesRegistrar
  {
    vtkRenderingUI_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingUI();
    }
  } vtkRenderingUI_SerDesRegistrar_Instance;
}
