...
VTKCOMMONMATH_EXPORT void AddRegistrar_vtkCommonMath();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonMath_SerDesRegistrar
  {
    vtkCommonMath_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonMath();
    }
  } vtkCommonMath_SerDesRegistrar_Instance;
}
