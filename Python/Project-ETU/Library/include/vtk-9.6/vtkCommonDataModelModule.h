...
VTKCOMMONDATAMODEL_EXPORT void AddRegistrar_vtkCommonDataModel();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonDataModel_SerDesRegistrar
  {
    vtkCommonDataModel_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonDataModel();
    }
  } vtkCommonDataModel_SerDesRegistrar_Instance;
}
