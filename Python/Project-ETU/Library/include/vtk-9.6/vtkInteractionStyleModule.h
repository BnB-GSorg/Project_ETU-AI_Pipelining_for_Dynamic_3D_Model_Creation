...
VTKINTERACTIONSTYLE_EXPORT void AddRegistrar_vtkInteractionStyle();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkInteractionStyle_SerDesRegistrar
  {
    vtkInteractionStyle_SerDesRegistrar()
    {
      AddRegistrar_vtkInteractionStyle();
    }
  } vtkInteractionStyle_SerDesRegistrar_Instance;
}
