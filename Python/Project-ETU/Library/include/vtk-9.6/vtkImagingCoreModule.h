...
VTKIMAGINGCORE_EXPORT void AddRegistrar_vtkImagingCore();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkImagingCore_SerDesRegistrar
  {
    vtkImagingCore_SerDesRegistrar()
    {
      AddRegistrar_vtkImagingCore();
    }
  } vtkImagingCore_SerDesRegistrar_Instance;
}
