...
VTKCHARTSCORE_EXPORT void AddRegistrar_vtkChartsCore();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkChartsCore_SerDesRegistrar
  {
    vtkChartsCore_SerDesRegistrar()
    {
      AddRegistrar_vtkChartsCore();
    }
  } vtkChartsCore_SerDesRegistrar_Instance;
}
