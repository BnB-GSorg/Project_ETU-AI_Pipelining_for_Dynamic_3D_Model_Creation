...
VTKFILTERSCORE_EXPORT void AddRegistrar_vtkFiltersCore();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkFiltersCore_SerDesRegistrar
  {
    vtkFiltersCore_SerDesRegistrar()
    {
      AddRegistrar_vtkFiltersCore();
    }
  } vtkFiltersCore_SerDesRegistrar_Instance;
}
