...
VTKRENDERINGLABEL_EXPORT void AddRegistrar_vtkRenderingLabel();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingLabel_SerDesRegistrar
  {
    vtkRenderingLabel_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingLabel();
    }
  } vtkRenderingLabel_SerDesRegistrar_Instance;
}
