...
VTKFILTERSSOURCES_EXPORT void AddRegistrar_vtkFiltersSources();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkFiltersSources_SerDesRegistrar
  {
    vtkFiltersSources_SerDesRegistrar()
    {
      AddRegistrar_vtkFiltersSources();
    }
  } vtkFiltersSources_SerDesRegistrar_Instance;
}
