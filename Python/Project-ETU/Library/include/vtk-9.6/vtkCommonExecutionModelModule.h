...
VTKCOMMONEXECUTIONMODEL_EXPORT void AddRegistrar_vtkCommonExecutionModel();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonExecutionModel_SerDesRegistrar
  {
    vtkCommonExecutionModel_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonExecutionModel();
    }
  } vtkCommonExecutionModel_SerDesRegistrar_Instance;
}
