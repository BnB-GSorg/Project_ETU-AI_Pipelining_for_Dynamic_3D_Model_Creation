...
VTKRENDERINGLICOPENGL2_EXPORT void AddRegistrar_vtkRenderingLICOpenGL2();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingLICOpenGL2_SerDesRegistrar
  {
    vtkRenderingLICOpenGL2_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingLICOpenGL2();
    }
  } vtkRenderingLICOpenGL2_SerDesRegistrar_Instance;
}
