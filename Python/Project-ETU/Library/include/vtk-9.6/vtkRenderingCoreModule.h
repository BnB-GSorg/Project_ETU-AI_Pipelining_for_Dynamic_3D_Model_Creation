...
VTKRENDERINGCORE_EXPORT void AddRegistrar_vtkRenderingCore();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingCore_SerDesRegistrar
  {
    vtkRenderingCore_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingCore();
    }
  } vtkRenderingCore_SerDesRegistrar_Instance;
}
