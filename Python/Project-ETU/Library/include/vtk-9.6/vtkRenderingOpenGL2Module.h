...
VTKRENDERINGOPENGL2_EXPORT void AddRegistrar_vtkRenderingOpenGL2();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingOpenGL2_SerDesRegistrar
  {
    vtkRenderingOpenGL2_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingOpenGL2();
    }
  } vtkRenderingOpenGL2_SerDesRegistrar_Instance;
}
