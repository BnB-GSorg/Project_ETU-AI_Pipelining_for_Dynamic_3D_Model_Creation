...
VTKIMAGINGCOLOR_EXPORT void AddRegistrar_vtkImagingColor();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkImagingColor_SerDesRegistrar
  {
    vtkImagingColor_SerDesRegistrar()
    {
      AddRegistrar_vtkImagingColor();
    }
  } vtkImagingColor_SerDesRegistrar_Instance;
}
