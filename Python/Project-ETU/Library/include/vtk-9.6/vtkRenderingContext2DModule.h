...
VTKRENDERINGCONTEXT2D_EXPORT void AddRegistrar_vtkRenderingContext2D();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingContext2D_SerDesRegistrar
  {
    vtkRenderingContext2D_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingContext2D();
    }
  } vtkRenderingContext2D_SerDesRegistrar_Instance;
}
