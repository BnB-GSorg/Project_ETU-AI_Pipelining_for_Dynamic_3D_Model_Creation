...
VTKRENDERINGVOLUMEOPENGL2_EXPORT void AddRegistrar_vtkRenderingVolumeOpenGL2();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingVolumeOpenGL2_SerDesRegistrar
  {
    vtkRenderingVolumeOpenGL2_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingVolumeOpenGL2();
    }
  } vtkRenderingVolumeOpenGL2_SerDesRegistrar_Instance;
}
