...
VTKCOMMONTRANSFORMS_EXPORT void AddRegistrar_vtkCommonTransforms();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonTransforms_SerDesRegistrar
  {
    vtkCommonTransforms_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonTransforms();
    }
  } vtkCommonTransforms_SerDesRegistrar_Instance;
}
