...
VTKINTERACTIONWIDGETS_EXPORT void AddRegistrar_vtkInteractionWidgets();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkInteractionWidgets_SerDesRegistrar
  {
    vtkInteractionWidgets_SerDesRegistrar()
    {
      AddRegistrar_vtkInteractionWidgets();
    }
  } vtkInteractionWidgets_SerDesRegistrar_Instance;
}
