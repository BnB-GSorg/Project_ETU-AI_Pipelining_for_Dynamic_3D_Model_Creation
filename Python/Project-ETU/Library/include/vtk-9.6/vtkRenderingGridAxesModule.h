...
VTKRENDERINGGRIDAXES_EXPORT void AddRegistrar_vtkRenderingGridAxes();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkRenderingGridAxes_SerDesRegistrar
  {
    vtkRenderingGridAxes_SerDesRegistrar()
    {
      AddRegistrar_vtkRenderingGridAxes();
    }
  } vtkRenderingGridAxes_SerDesRegistrar_Instance;
}
