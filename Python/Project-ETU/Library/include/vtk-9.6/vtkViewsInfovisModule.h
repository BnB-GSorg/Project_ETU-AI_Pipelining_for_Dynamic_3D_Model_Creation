...
VTKVIEWSINFOVIS_EXPORT void AddRegistrar_vtkViewsInfovis();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkViewsInfovis_SerDesRegistrar
  {
    vtkViewsInfovis_SerDesRegistrar()
    {
      AddRegistrar_vtkViewsInfovis();
    }
  } vtkViewsInfovis_SerDesRegistrar_Instance;
}
