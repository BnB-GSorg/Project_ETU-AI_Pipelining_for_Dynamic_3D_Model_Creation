...
VTKCOMMONMISC_EXPORT void AddRegistrar_vtkCommonMisc();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonMisc_SerDesRegistrar
  {
    vtkCommonMisc_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonMisc();
    }
  } vtkCommonMisc_SerDesRegistrar_Instance;
}
