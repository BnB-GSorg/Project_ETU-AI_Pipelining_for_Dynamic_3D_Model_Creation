...
VTKCOMMONCOLOR_EXPORT void AddRegistrar_vtkCommonColor();
VTK_ABI_NAMESPACE_END
namespace
{
  struct vtkCommonColor_SerDesRegistrar
  {
    vtkCommonColor_SerDesRegistrar()
    {
      AddRegistrar_vtkCommonColor();
    }
  } vtkCommonColor_SerDesRegistrar_Instance;
}
