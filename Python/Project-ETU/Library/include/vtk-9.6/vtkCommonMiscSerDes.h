...
#ifndef vtkCommonMiscSerDes_h
#define vtkCommonMiscSerDes_h

#include "vtkCommonMiscModule.h"

#define RegisterClasses_vtkCommonMisc VTK_ABI_NAMESPACE_MANGLE(RegisterClasses_vtkCommonMisc)
...
extern "C"
{
   ...
   */
  VTKCOMMONMISC_EXPORT int RegisterClasses_vtkCommonMisc(void* serializer, void* deserializer, void* invoker, const char** error);
}

VTK_ABI_NAMESPACE_END
#endif
// VTKHeaderTest-Exclude: vtkCommonMiscSerDes.h
